...
class SignUpVC: UIViewController , AKFViewControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        print("In SignUp VC", paramDictionary)
    ...
    @IBAction func commonBtnAction(_ sender: UIButton) {
        ...
        case 101:                   // SignUp Btn
            if isAllFieldVerified(){
                ...
                uploadDocument.email = userObj.email
                uploadDocument.password = userObj.password
                uploadDocument.fullName = userObj.fullName
                uploadDocument.phoneNumebr = userObj.phoneNumebr
...
extension SignUpVC {
    ...
    func signUpAPi(){
        ...
        ServiceHelper.sharedInstance.createPostRequest(isShowHud: true, params: paramDic as [String : AnyObject], apiName: API_PROVIDER_REGISTER) { (response, error) in
            if error != nil {
