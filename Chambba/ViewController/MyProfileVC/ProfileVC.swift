...
class ProfileVC: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func commonBtnAction(_ sender: UIButton) {
        ...
        case 103:                   // Change Password Btn
            ...
            break
        case 104:                   // Change Password Btn
            let serviceVC = mainStoryboard.instantiateViewController(withIdentifier: "ServicesVC") as! ServicesVC
            serviceVC.serviceArray = responseData["service"].arrayValue
    ...
    @IBAction func stripeConnectiBtnAction(_ sender: UIButton) {
        let stripeAdaptivePaymentVC = mainStoryboard.instantiateViewController(withIdentifier: "StripeAdaptivePaymentVC") as! StripeAdaptivePaymentVC
        self.navigationController?.pushViewController(stripeAdaptivePaymentVC, animated: true)
    }
    ...
    func updateProfile() {
        ...
        ServiceHelper.sharedInstance.createRequestToUploadDataWithString(additionalParams: params, dataContent: imageData, strName: "avatar", strFileName: "user.jpg", strType: "file", apiName: API_Update_Profile) { (response, error) in
            ...
            if response != nil {
                ...
                let picture = result.validatedValue("avatar", expected: "" as AnyObject) as! String
